...
def test_transcription_job_records_queue_message_id(app_client, patched_db, monkeypatch) -> None:
    ...
    monkeypatch.setattr("src.api.routers.transcription.get_queue_adapter", lambda: _DummyQueueAdapter())
    ...
    assert job["queue_message_id"] == "azure-msg-123"
